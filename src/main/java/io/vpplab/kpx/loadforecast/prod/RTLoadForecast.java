...
/**
 * <p>RTLoadForecast complex type에 대한 Java 클래스입니다.</p>
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.</p>
 * 
 * <pre>{@code
 * <complexType name="RTLoadForecast">
 *   <complexContent>
...
@XmlType(name = "RTLoadForecast", namespace = "http://www.kpx.or.kr/2014/schema/loadforecast#", propOrder = {
    "market",
    "mktLoadArea",
    "schedule",
    "areaLoadCurve"
})
public class RTLoadForecast {
